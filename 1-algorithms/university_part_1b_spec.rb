...
describe "Part 1b: Your Array of Universities" do
  ...
  let(:universities) {
    [
      University.new('name' => 'Purdue',
      'application_stats' => { 'applied' => 170, 'rejected' => 90, 'accepted' => 80 }
      ),
      University.new('name' => 'Indiana',
      'application_stats' => { 'applied' => 300, 'rejected' => 135, 'accepted' => 165 }
      ),
      University.new('name' => 'Notre Dame',
      'application_stats' => { 'applied' => 500, 'rejected' => 220, 'accepted' => 230 }
      ),
      University.new('name' => 'Toledo',
      'application_stats' => { 'applied' => 404, 'rejected' => 180, 'accepted' => 224 }
      )
    ]
  }
  ...
  it 'should have all non-zero stats' do
