...
describe "Part 1b: Your Array of Universities" do
  ...
  let(:universities) {[University.new(name:"Purdue",application_stats:{'applied'=>170,'rejected'=>90,'accepted'=>80}),
    University.new(name:"Indiana",application_stats:{'applied'=>300,'rejected'=>135,'accepted'=>165}),
    University.new(name:"Notre Dame",application_stats:{'applied'=>500,'rejected'=>220,'accepted'=>230}),
    University.new(name:"Toledo",application_stats:{'applied'=>404,'rejected'=>180,'accepted'=>224})]}
  ...
  it 'should contain only instances of the University class' do
    expect(universities.all?{ |university| university.class == University }).to be(true)
  end

  #Give a good name for this test too!
  it 'should not have 0 as a value for applied, rejected, or accepted statistics' do
